...
/* harmony export */   "CursorHelpers": () => (/* binding */ CursorHelpers)
/* harmony export */ });
...
var CursorHelpersClass = /*#__PURE__*/function () {
  function CursorHelpersClass() {
    ...
    this.onMouseMove = lodash_throttle__WEBPACK_IMPORTED_MODULE_2___default()(this.handleMouseMove, ON_MOUSE_MOVE_THROTTLE_MS, {
      leading: true,
      trailing: false
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryCursorContainer": () => (/* binding */ VictoryCursorContainer),
...
/* harmony import */ var _cursor_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cursor-helpers */ "./cursor-helpers.tsx");
    ...
    _createClass(VictoryCursorContainer, [{
      ...
      value: function getPadding(props) {
        if (props.padding === undefined) {
          ...
          return victory_core__WEBPACK_IMPORTED_MODULE_3__.getPadding(child.props);
        }

        return victory_core__WEBPACK_IMPORTED_MODULE_3__.getPadding(props);
      }
    }, {
      ...
      value: function getCursorElements(props) {
        ...
        var scale = props.scale,
            ...
            theme = props.theme;
        var cursorDimension = _cursor_helpers__WEBPACK_IMPORTED_MODULE_4__.CursorHelpers.getDimension(props);
        ...
        if (cursorLabel) {
          var labelProps = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({
            active: true
          ...
          if (victory_core__WEBPACK_IMPORTED_MODULE_3__.isTooltip(cursorLabelComponent)) {
          ...
          newElements.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(cursorLabelComponent, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, labelProps, {
            text: victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(cursorLabel, labelProps)
          })));
        }
      ...
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(props.children)), _toConsumableArray(this.getCursorElements(props)));
      }
    }]);

    return VictoryCursorContainer;
  }(Base), _class.displayName = "VictoryCursorContainer", _class.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.propTypes), {}, {
    cursorDimension: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["x", "y"]),
    cursorLabel: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func),
    cursorLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
    cursorLabelOffset: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
      x: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
      y: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number)
    })]),
    defaultCursorValue: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
      x: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
      y: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number)
    })]),
    disable: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
    onCursorChange: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)
  }), _class.defaultProps = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.defaultProps), {}, {
    cursorLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryLabel, null),
    cursorLabelOffset: {
      x: 5,
      y: -10
    },
    cursorComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.LineSegment, null)
  }), _class.defaultEvents = function (props) {
    return [{
      target: "parent",
      eventHandlers: {
        onMouseLeave: function (evt, targetProps) {
          return props.disable ? {} : _cursor_helpers__WEBPACK_IMPORTED_MODULE_4__.CursorHelpers.onMouseLeave(evt, targetProps);
        },
        onTouchCancel: function () {
          return [];
        },
        onMouseMove: function (evt, targetProps) {
          return props.disable ? {} : _cursor_helpers__WEBPACK_IMPORTED_MODULE_4__.CursorHelpers.onMouseMove(evt, targetProps);
        },
...
var VictoryCursorContainer = cursorContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CursorHelpers": () => (/* reexport safe */ _cursor_helpers__WEBPACK_IMPORTED_MODULE_0__.CursorHelpers),
/* harmony export */   "VictoryCursorContainer": () => (/* reexport safe */ _victory_cursor_container__WEBPACK_IMPORTED_MODULE_1__.VictoryCursorContainer),
/* harmony export */   "cursorContainerMixin": () => (/* reexport safe */ _victory_cursor_container__WEBPACK_IMPORTED_MODULE_1__.cursorContainerMixin)
/* harmony export */ });
