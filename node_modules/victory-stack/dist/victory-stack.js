...
function stackData(props, childComponents) {
  var dataFromChildren = victory_core__WEBPACK_IMPORTED_MODULE_4__.getDataFromChildren(props, childComponents);
...
function getCalculatedProps(initialProps, childComponents) {
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(initialProps.children);
  var role = "stack";
  var props = victory_core__WEBPACK_IMPORTED_MODULE_5__.modifyProps(initialProps, fallbackProps, role);
  var style = victory_core__WEBPACK_IMPORTED_MODULE_4__.getStyle(props.theme, props.style, role);
  var categories = props.categories || victory_core__WEBPACK_IMPORTED_MODULE_4__.getCategories(props, children);
  var datasets = props.datasets || stackData(props, children);
  var clonedChildren = children.map(function (c, i) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(c, {
      data: datasets[i]
    });
  });
  var domain = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomain(Object.assign({}, props, {
      categories: categories
    }), "x", clonedChildren),
    y: victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomain(Object.assign({}, props, {
      categories: categories
    }), "y", clonedChildren)
  };
  ...
  var baseScale = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_6__.getScaleFromProps(props, "x") || victory_core__WEBPACK_IMPORTED_MODULE_4__.getScale(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_6__.getScaleFromProps(props, "y") || victory_core__WEBPACK_IMPORTED_MODULE_4__.getScale(props, "y")
  };
  var scale = {
...
var withoutSharedEvents = function (props) {
  ...
  var modifiedChildren = react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(children).map(function (_child) {
    var child = _child;
    return _objectSpread(_objectSpread({}, child), {}, {
      props: victory_core__WEBPACK_IMPORTED_MODULE_5__.omit(child.props, ["sharedEvents"])
    });
  });
...
function useMemoizedProps(initialProps) {
  ...
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_2___default().useState(modifiedProps),
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default().useEffect(function () {
    if (!react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default()(modifiedProps, props)) {
      setProps(modifiedProps);
    }
  }, [props, setProps, modifiedProps]);
  return react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
...
function getChildProps(props, calculatedProps) {
  ...
  return {
    height: props.height,
    width: props.width,
    padding: victory_core__WEBPACK_IMPORTED_MODULE_5__.getPadding(props),
    standalone: false,
    theme: props.theme,
    categories: categories,
    domain: domain,
...
function getChildren(initialProps, childComponents, calculatedProps) {
  var props = victory_core__WEBPACK_IMPORTED_MODULE_5__.modifyProps(initialProps, fallbackProps, "stack");
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(props.children);
  ...
  return children.map(function (child, index) {
    ...
    var style = victory_core__WEBPACK_IMPORTED_MODULE_4__.getChildStyle(child, index, newCalculatedProps);
    var labels = props.labels ? getLabels(props, datasets, index) : child.props.labels;
    var name = child.props.name || "".concat(parentName, "-").concat(role, "-").concat(index);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(child, Object.assign({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryStack": () => (/* binding */ VictoryStack)
/* harmony export */ });
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! prop-types */ "../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/common-props.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/prop-types.js");
...
var VictoryStackBase = function (initialProps) {
  ...
  var propsWithDefaults = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
    return _objectSpread(_objectSpread({}, defaultProps), initialProps);
  }, [initialProps]);

  var _Hooks$useAnimationSt = victory_core__WEBPACK_IMPORTED_MODULE_6__.useAnimationState(),
  ...
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_7__.modifyProps(props, fallbackProps, role);
  ...
  var childComponents = react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(modifiedProps.children);
  var calculatedProps = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_8__.useMemoizedProps)(modifiedProps);
  var domain = calculatedProps.domain,
      scale = calculatedProps.scale,
      style = calculatedProps.style;
  var newChildren = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
    var children = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_8__.getChildren)(props, childComponents, calculatedProps);
  ...
  var containerProps = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
    if (standalone) {
      return {
        domain: domain,
        scale: scale,
  ...
  var userProps = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
    return victory_core__WEBPACK_IMPORTED_MODULE_9__.getSafeUserProps(propsWithDefaults);
  }, [propsWithDefaults]);
  var container = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
    if (standalone) {
  ...
  var events = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(function () {
    return victory_core__WEBPACK_IMPORTED_MODULE_10__.getAllEvents(props);
  }, [props]);
  var previousProps = victory_core__WEBPACK_IMPORTED_MODULE_11__.usePreviousProps(propsWithDefaults);
  react__WEBPACK_IMPORTED_MODULE_2___default().useEffect(function () {
...
VictoryStackBase.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_13__.CommonProps.baseProps), {}, {
  bins: prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_14___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_15__.nonNegative, prop_types__WEBPACK_IMPORTED_MODULE_14___default().instanceOf(Date)])), victory_core__WEBPACK_IMPORTED_MODULE_15__.nonNegative]),
  categories: prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_14___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_14___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_14___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_14___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_14___default().string)),
    y: prop_types__WEBPACK_IMPORTED_MODULE_14___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_14___default().string))
  })]),
  children: prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_14___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_14___default().node)), (prop_types__WEBPACK_IMPORTED_MODULE_14___default().node)]),
  colorScale: prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_14___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_14___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOf(["grayscale", "qualitative", "heatmap", "warm", "cool", "red", "green", "blue"])]),
  fillInMissingData: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().bool),
  horizontal: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().bool),
  labelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().element),
  labels: prop_types__WEBPACK_IMPORTED_MODULE_14___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_14___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_14___default().array)]),
  style: prop_types__WEBPACK_IMPORTED_MODULE_14___default().shape({
    parent: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().object),
    data: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().object),
    labels: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().object)
  }),
  xOffset: (prop_types__WEBPACK_IMPORTED_MODULE_14___default().number)
});
var componentConfig = {
  role: "stack",
...
var VictoryStack = Object.assign( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().memo(VictoryStackBase, (react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default())), componentConfig);
...
/* harmony import */ var _axis__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./axis */ "../../victory-core/es/victory-util/axis.js");
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./style */ "../../victory-core/es/victory-util/style.js");
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./data */ "../../victory-core/es/victory-util/data.js");
/* harmony import */ var _domain__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./domain */ "../../victory-core/es/victory-util/domain.js");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./events */ "../../victory-core/es/victory-util/events.js");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helpers */ "../../victory-core/es/victory-util/helpers.js");
/* harmony import */ var _scale__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./scale */ "../../victory-core/es/victory-util/scale.js");
/* harmony import */ var _log__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./log */ "../../victory-core/es/victory-util/log.js");
...
function addBinsToParentPropsIfHistogram(_ref) {
  ...
  if (someChildrenAreHistograms && !allChildrenAreHistograms) {
    _log__WEBPACK_IMPORTED_MODULE_9__.warn("VictoryHistogram only supports being stacked with other VictoryHistogram components. Check to make sure that you are only passing VictoryHistogram components to VictoryStack");
  ...
  if (!Array.isArray(childBins)) {
    var combinedData = children.reduce(function (memo, child) {
      var xAccessor = _helpers__WEBPACK_IMPORTED_MODULE_10__.createAccessor(child.props.x || "x");
...
function getDataFromChildren(props, childComponents) {
  ...
  var stack = 0;
  var children = childComponents ? childComponents.slice(0) : react__WEBPACK_IMPORTED_MODULE_8___default().Children.toArray(props.children);
  ...
  var iteratee = function (child, childName, parent) {
    ...
    if (!_data__WEBPACK_IMPORTED_MODULE_11__.isDataComponent(child)) {
      return null;
    } else if (child.type && lodash_isFunction__WEBPACK_IMPORTED_MODULE_5___default()(child.type.getData)) {
      childElement = parent ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().cloneElement(child, parent.props) : child;
      childData = childElement.type.getData(childProps);
    } else {
      childData = _data__WEBPACK_IMPORTED_MODULE_11__.getData(childProps);
    }
  ...
  var datasets = _helpers__WEBPACK_IMPORTED_MODULE_10__.reduceChildren(children, iteratee, props, [], combine);
...
function getData(props, childComponents) {
  if (props.data) {
    return _data__WEBPACK_IMPORTED_MODULE_11__.getData(props);
  }

  return getDataFromChildren(props, childComponents || react__WEBPACK_IMPORTED_MODULE_8___default().Children.toArray(props.children));
}
function getWidth(props, groupLength, seriesLength) {
  var datasets = props.datasets,
      horizontal = props.horizontal;
  var range = horizontal ? _helpers__WEBPACK_IMPORTED_MODULE_10__.getRange(props, "y") : _helpers__WEBPACK_IMPORTED_MODULE_10__.getRange(props, "x");
...
function getDomainFromChildren(props, axis, childComponents) {
  ...
  var children = childComponents ? childComponents.slice(0) : react__WEBPACK_IMPORTED_MODULE_8___default().Children.toArray(props.children);
  var parentData = props.data ? _data__WEBPACK_IMPORTED_MODULE_11__.getData(props) : undefined;
  var polar = props.polar,
      startAngle = props.startAngle,
      endAngle = props.endAngle,
      categories = props.categories,
  ...
  var iteratee = function (child) {
    ...
    if (!_domain__WEBPACK_IMPORTED_MODULE_12__.isDomainComponent(child)) {
      return null;
    ...
    return _domain__WEBPACK_IMPORTED_MODULE_12__.getDomain(sharedProps, axis);
  };

  var childDomains = _helpers__WEBPACK_IMPORTED_MODULE_10__.reduceChildren(children, iteratee, props);
  var min = childDomains.length === 0 ? 0 : _collection__WEBPACK_IMPORTED_MODULE_13__.getMinValue(childDomains);
  var max = childDomains.length === 0 ? 1 : _collection__WEBPACK_IMPORTED_MODULE_13__.getMaxValue(childDomains);
  return [min, max];
}
function getDomain(props, axis, childComponents) {
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_8___default().Children.toArray(props.children);
  var propsDomain = _domain__WEBPACK_IMPORTED_MODULE_12__.getDomainFromProps(props, axis);
  ...
  if (propsDomain) {
    ...
    var minDomain = _domain__WEBPACK_IMPORTED_MODULE_12__.getMinFromProps(props, axis);
    var maxDomain = _domain__WEBPACK_IMPORTED_MODULE_12__.getMaxFromProps(props, axis);
    var dataset = (props.data || props.y) && _data__WEBPACK_IMPORTED_MODULE_11__.getData(props);
    var dataDomain = dataset ? _domain__WEBPACK_IMPORTED_MODULE_12__.getDomainFromData(props, axis, dataset) : [];
    var childDomain = getDomainFromChildren(props, axis, children);
    var min = minDomain || _collection__WEBPACK_IMPORTED_MODULE_13__.getMinValue([].concat(_toConsumableArray(dataDomain), _toConsumableArray(childDomain)));
    var max = maxDomain || _collection__WEBPACK_IMPORTED_MODULE_13__.getMaxValue([].concat(_toConsumableArray(dataDomain), _toConsumableArray(childDomain)));
    domain = _domain__WEBPACK_IMPORTED_MODULE_12__.getDomainFromMinMax(min, max);
  }

  return _domain__WEBPACK_IMPORTED_MODULE_12__.formatDomain(domain, Object.assign({
    domainPadding: domainPadding
  }, props), axis);
}
function getScale(props, axis, childComponents) {
  if (props.data) {
    return _scale__WEBPACK_IMPORTED_MODULE_14__.getBaseScale(props, axis);
  }
  ...
  var iteratee = function (child) {
    ...
    return _scale__WEBPACK_IMPORTED_MODULE_14__.getScaleType(sharedProps, axis);
  };

  var childScale = lodash_uniq__WEBPACK_IMPORTED_MODULE_4___default()(_helpers__WEBPACK_IMPORTED_MODULE_10__.reduceChildren(children, iteratee, props)); // default to linear scale if more than one uniq scale type is given by children


  return childScale.length > 1 ? _scale__WEBPACK_IMPORTED_MODULE_14__.getScaleFromName("linear") : _scale__WEBPACK_IMPORTED_MODULE_14__.getScaleFromName(childScale[0]);
}
function getAllEvents(props) {
  var components = ["groupComponent", "containerComponent", "labelComponent"];
  var componentEvents = _events__WEBPACK_IMPORTED_MODULE_15__.getComponentEvents(props, components);
...
function getColor(calculatedProps, child, index) {
  ...
  var colors = Array.isArray(colorScale) ? colorScale : _style__WEBPACK_IMPORTED_MODULE_16__.getColorScale(colorScale);
  return color || colors[index % colors.length];
}
function getStyle(theme, style, role) {
  var defaultStyle = theme && theme[role] && theme[role].style ? theme[role].style : {};
  return _helpers__WEBPACK_IMPORTED_MODULE_10__.getStyles(style, defaultStyle);
}
function getChildStyle(child, index, calculatedProps) {
  ...
  var dataStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_7___default()({}, childStyle.data, Object.assign({}, dataWidth, style.data, defaultColor));
...
function getStringsFromCategories(childComponents, axis) {
  var iteratee = function (child) {
    ...
    if (!_domain__WEBPACK_IMPORTED_MODULE_12__.isDomainComponent(child) || !childProps.categories) {
      return null;
    }
    ...
    return categoryStrings ? _collection__WEBPACK_IMPORTED_MODULE_13__.removeUndefined(categoryStrings) : [];
  };

  return _helpers__WEBPACK_IMPORTED_MODULE_10__.reduceChildren(childComponents.slice(0), iteratee);
}
function getStringsFromData(childComponents) {
  var iteratee = function (child) {
    ...
    if (!_data__WEBPACK_IMPORTED_MODULE_11__.isDataComponent(child)) {
      ...
      data = _data__WEBPACK_IMPORTED_MODULE_11__.getData(childProps);
    }
  ...
  return _helpers__WEBPACK_IMPORTED_MODULE_10__.reduceChildren(childComponents.slice(0), iteratee, {}, initialMemo, combine);
}
function getCategoryAndAxisStringsFromChildren(props, axis, childComponents) {
  ...
  var axisComponent = _axis__WEBPACK_IMPORTED_MODULE_17__.getAxisComponent(childComponents, axis);
  var axisStrings = axisComponent ? _data__WEBPACK_IMPORTED_MODULE_11__.getStringsFromAxes(axisComponent.props, axis) : [];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictorySharedEvents": () => (/* binding */ VictorySharedEvents)
/* harmony export */ });
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/events.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/timer-context.js");
...
/* harmony import */ var json_stringify_safe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! json-stringify-safe */ "../../../node_modules/.pnpm/json-stringify-safe@5.0.1/node_modules/json-stringify-safe/stringify.js");
/* harmony import */ var json_stringify_safe__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(json_stringify_safe__WEBPACK_IMPORTED_MODULE_8__);
...
var VictorySharedEvents = /*#__PURE__*/function (_React$Component) {
  ...
  function VictorySharedEvents(props) {
    ...
    _this.getScopedEvents = victory_core__WEBPACK_IMPORTED_MODULE_9__.getScopedEvents.bind(_assertThisInitialized(_this));
    _this.getEventState = victory_core__WEBPACK_IMPORTED_MODULE_9__.getEventState.bind(_assertThisInitialized(_this));
  ...
  _createClass(VictorySharedEvents, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (!react_fast_compare__WEBPACK_IMPORTED_MODULE_7___default()(this.props, nextProps)) {
    ...
    value: function addGlobalListener(key) {
      ...
      var boundListener = function (event) {
        ...
        return listener && listener(victory_core__WEBPACK_IMPORTED_MODULE_9__.emulateReactEvent(event));
      };

      this.boundGlobalEvents[key] = boundListener;
      window.addEventListener(victory_core__WEBPACK_IMPORTED_MODULE_9__.getGlobalEventNameFromKey(key), boundListener);
    }
  }, {
    key: "removeGlobalListener",
    value: function removeGlobalListener(key) {
      window.removeEventListener(victory_core__WEBPACK_IMPORTED_MODULE_9__.getGlobalEventNameFromKey(key), this.boundGlobalEvents[key]);
    }
  }, {
    key: "getAllEvents",
    value: function getAllEvents(props) {
      var components = ["container", "groupComponent"];
      var componentEvents = victory_core__WEBPACK_IMPORTED_MODULE_9__.getComponentEvents(props, components);
    ...
    value: function getExternalMutations(props, baseProps) {
      return !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_3___default()(props.externalEventMutations) ? victory_core__WEBPACK_IMPORTED_MODULE_9__.getExternalMutationsWithChildren(props.externalEventMutations, baseProps, this.state, lodash_keys__WEBPACK_IMPORTED_MODULE_1___default()(baseProps)) : undefined;
    }
  }, {
    ...
    value: function getCachedSharedEvents(name, cacheValues) {
      ...
      if (sharedEvents && react_fast_compare__WEBPACK_IMPORTED_MODULE_7___default()(cacheValues, prevCacheValues)) {
        return sharedEvents;
      }
    ...
    value: function getBaseProps(props) {
      ...
      var children = react__WEBPACK_IMPORTED_MODULE_6___default().Children.toArray(this.props.children);
    ...
    value: function getBasePropsFromChildren(childComponents) {
      ...
      var baseProps = victory_core__WEBPACK_IMPORTED_MODULE_10__.reduceChildren(childComponents, iteratee);
    ...
    value: function getNewChildren(props, baseProps) {
      ...
      var alterChildren = function (children, childNames) {
        return children.reduce(function (memo, child, index) {
          if (child.props.children) {
            var newChildren = react__WEBPACK_IMPORTED_MODULE_6___default().Children.toArray(child.props.children);
            var names = childNames.slice(index, index + newChildren.length);
            var results = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().cloneElement(child, child.props, alterChildren(newChildren, names));
            ...
            var sharedEventsCacheValues = [name, baseProps, childEvents, json_stringify_safe__WEBPACK_IMPORTED_MODULE_8___default()(_this6.state[name])];
            ...
            return memo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().cloneElement(child, Object.assign({
      ...
      var childComponents = react__WEBPACK_IMPORTED_MODULE_6___default().Children.toArray(props.children);
    ...
    value: function getContainer(props, baseProps, events) {
      ...
      var boundGetEvents = victory_core__WEBPACK_IMPORTED_MODULE_9__.getEvents.bind(this);
      ...
      var containerEvents = lodash_defaults__WEBPACK_IMPORTED_MODULE_4___default()({}, victory_core__WEBPACK_IMPORTED_MODULE_9__.getPartialEvents(parentEvents, "parent", parentProps), containerProps.events);

      this.globalEvents = victory_core__WEBPACK_IMPORTED_MODULE_9__.getGlobalEvents(containerEvents);
      var localEvents = victory_core__WEBPACK_IMPORTED_MODULE_9__.omitGlobalEvents(containerEvents);
      return role === "container" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().cloneElement(container, Object.assign({}, parentProps, {
        events: localEvents
      })) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().cloneElement(container, localEvents, children);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().cloneElement(this.props.container, {
...
VictorySharedEvents.contextType = victory_core__WEBPACK_IMPORTED_MODULE_11__["default"];
VictorySharedEvents.defaultProps = {
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default().createElement("g", null)
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryStack": () => (/* reexport safe */ _victory_stack__WEBPACK_IMPORTED_MODULE_0__.VictoryStack)
/* harmony export */ });
