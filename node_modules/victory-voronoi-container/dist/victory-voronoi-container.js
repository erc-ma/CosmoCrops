...
/* harmony export */   "VictoryVoronoiContainer": () => (/* binding */ VictoryVoronoiContainer),
...
/* harmony import */ var victory_tooltip__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! victory-tooltip */ "../../victory-tooltip/es/victory-tooltip.js");
...
/* harmony import */ var _voronoi_helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./voronoi-helpers */ "./voronoi-helpers.ts");
...
function voronoiContainerMixin(Base) {
  ...
  }(Base), _class.displayName = "VictoryVoronoiContainer", _class.defaultProps = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.defaultProps), {}, {
    activateData: true,
    activateLabels: true,
    labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_tooltip__WEBPACK_IMPORTED_MODULE_6__.VictoryTooltip, null),
    voronoiPadding: 5
    ...
    return [{
      ...
      eventHandlers: {
        onMouseLeave: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_7__.VoronoiHelpers.onMouseLeave(evt, targetProps);
        },
        onTouchCancel: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_7__.VoronoiHelpers.onMouseLeave(evt, targetProps);
        },
        onMouseMove: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_7__.VoronoiHelpers.onMouseMove(evt, targetProps);
        },
...
var VictoryVoronoiContainer = voronoiContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VoronoiHelpers": () => (/* binding */ VoronoiHelpers)
/* harmony export */ });
...
/* harmony import */ var lodash_isString__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/isString */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isString.js");
/* harmony import */ var lodash_isString__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_isString__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var lodash_includes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash/includes */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/includes.js");
...
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-fast-compare */ "../../../node_modules/.pnpm/react-fast-compare@3.2.0/node_modules/react-fast-compare/index.js");
...
/* harmony import */ var delaunay_find_lib_index_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! delaunay-find/lib/index.js */ "../../../node_modules/.pnpm/delaunay-find@0.0.6/node_modules/delaunay-find/lib/index.js");
...
var VoronoiHelpersClass = /*#__PURE__*/function () {
  function VoronoiHelpersClass() {
    ...
    this.handleMouseMove = function (evt, targetProps) {
      ...
      var activePoints = targetProps.activePoints || [];
      var parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_9__.getParentSVG(evt);
      var mousePosition = victory_core__WEBPACK_IMPORTED_MODULE_9__.getSVGEventCoordinates(evt, parentSVG);
      ...
      if (activePoints.length && react_fast_compare__WEBPACK_IMPORTED_MODULE_6___default()(points, activePoints)) {
    ...
    this.onMouseMove = lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default()(this.handleMouseMove, ON_MOUSE_MOVE_THROTTLE_MS, {
      leading: true,
      trailing: false
    });
  }
  ...
  _createClass(VoronoiHelpersClass, [{
    ...
    value: function getDatasets(props) {
      ...
      var children = react__WEBPACK_IMPORTED_MODULE_8___default().Children.toArray(props.children);
      ...
      var iteratee = function (child, childName) {
        ...
        var blacklistStr = blacklist.filter((lodash_isString__WEBPACK_IMPORTED_MODULE_2___default()));
        var blacklistRegExp = blacklist.filter((lodash_isRegExp__WEBPACK_IMPORTED_MODULE_1___default()));
        var isRegExpMatch = blacklistRegExp.some(function (regExp) {
          return regExp.test(name);
        });

        if (!victory_core__WEBPACK_IMPORTED_MODULE_12__.isDataComponent(child) || lodash_includes__WEBPACK_IMPORTED_MODULE_3___default()(blacklistStr, name) || isRegExpMatch) {
          return null;
        }

        var getChildData = child.type && lodash_isFunction__WEBPACK_IMPORTED_MODULE_5___default()(child.type.getData) ? child.type.getData : getData;
    ...
    value: function getVoronoiPoints(props, mousePosition) {
      ...
      var delaunay = delaunay_find_lib_index_js__WEBPACK_IMPORTED_MODULE_7__["default"].from(scaledData);
    ...
    value: function getActiveMutations(props, point) {
      ...
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_4___default()(targets)) {
        return [];
      }
    ...
    value: function onActivated(props, points) {
      if (lodash_isFunction__WEBPACK_IMPORTED_MODULE_5___default()(props.onActivated)) {
    ...
    value: function onDeactivated(props, points) {
      if (lodash_isFunction__WEBPACK_IMPORTED_MODULE_5___default()(props.onDeactivated)) {
...
var Flyout = function (initialProps) {
  var props = evaluateProps(_objectSpread(_objectSpread({}, defaultProps), initialProps));
  var userProps = victory_core__WEBPACK_IMPORTED_MODULE_3__.getSafeUserProps(props); // check for required props for this subcomponent
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(props.pathComponent, _objectSpread(_objectSpread(_objectSpread({}, props.events), userProps), {}, {
    style: props.style,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryTooltip": () => (/* binding */ VictoryTooltip)
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-portal/victory-portal.js");
...
/* harmony import */ var _flyout__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./flyout */ "../../victory-tooltip/es/flyout.js");
...
var VictoryTooltip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryTooltip, [{
    ...
    value: function getPolarOrientation(props) {
      var degrees = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDegrees(props, props.datum);
    ...
    value: function getStyles(props) {
      var theme = props.theme || victory_core__WEBPACK_IMPORTED_MODULE_6__.VictoryTheme.grayscale;
      ...
      var style = Array.isArray(baseLabelStyle) ? baseLabelStyle.map(function (s) {
        return victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateStyle(s, props);
      }) : victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateStyle(baseLabelStyle, props);
      var flyoutStyle = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateStyle(baseFlyoutStyle, Object.assign({}, props, {
        style: style
      }));
      return {
        style: style,
    ...
    value: function getEvaluatedProps(props) {
      var cornerRadius = props.cornerRadius,
          ...
          dx = props.dx,
          dy = props.dy;
      var active = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.active, props);
      var text = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.text, Object.assign({}, props, {
        active: active
      }));
      ...
      var orientation = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.orientation, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle
      })) || this.getDefaultOrientation(props);
      var padding = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.flyoutPadding, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var flyoutPadding = victory_core__WEBPACK_IMPORTED_MODULE_7__.getPadding({
        padding: padding
      });
      var pointerWidth = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.pointerWidth, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var pointerLength = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.pointerLength, Object.assign({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var labelSize = victory_core__WEBPACK_IMPORTED_MODULE_8__.approximateTextSize(text, style);
      ...
      var offsetX = lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_1___default()(centerOffset) && (centerOffset === null || centerOffset === void 0 ? void 0 : centerOffset.x) !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(centerOffset.x, evaluatedProps) : 0;
      var offsetY = lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_1___default()(centerOffset) && (centerOffset === null || centerOffset === void 0 ? void 0 : centerOffset.y) !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(centerOffset.y, evaluatedProps) : 0;
      return _objectSpread(_objectSpread({}, evaluatedProps), {}, {
        centerOffset: {
          x: offsetX,
          y: offsetY
        },
        dx: dx !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(dx, evaluatedProps) : 0,
        dy: dy !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(dy, evaluatedProps) : 0,
        cornerRadius: victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(cornerRadius, evaluatedProps)
      });
    }
  }, {
    ...
    value: function getDefaultAngle(props) {
      ...
      var degrees = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDegrees(props, datum);
      var sign = degrees > 90 && degrees < 180 || degrees > 270 ? 1 : -1;
      var labelRotation = labelPlacement === "perpendicular" ? 0 : 90;
      var angle = 0;
    ...
    value: function getDimensions(props, labelSize) {
      ...
      var cornerRadius = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.cornerRadius, props);
      ...
      return {
        flyoutHeight: flyoutHeight ? victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(flyoutHeight, props) : getHeight(),
        flyoutWidth: flyoutWidth ? victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(flyoutWidth, props) : getWidth()
      };
    }
  }, {
    key: "getLabelProps",
    ...
    value: function getFlyoutProps(props, calculatedValues) {
      ...
      var pointerOrientation = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateProp(props.pointerOrientation, props);
    ...
    value: function renderTooltip(props) {
      ...
      if (!active) {
        return renderInPortal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryPortal, null) : null;
      }
      ...
      var children = [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(flyoutComponent, this.getFlyoutProps(evaluatedProps, calculatedValues)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(labelComponent, this.getLabelProps(evaluatedProps, calculatedValues))];
      var tooltip = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(groupComponent, {
        role: "presentation",
        transform: calculatedValues.transform
      }, children);
      return renderInPortal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryPortal, null, tooltip) : tooltip;
    }
  }, {
    key: "render",
    value: function render() {
      var props = victory_core__WEBPACK_IMPORTED_MODULE_7__.modifyProps(this.props, fallbackProps, "tooltip");
...
VictoryTooltip.defaultProps = {
  active: false,
  renderInPortal: true,
  labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.VictoryLabel, null),
  flyoutComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_flyout__WEBPACK_IMPORTED_MODULE_11__.Flyout, null),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryVoronoiContainer": () => (/* reexport safe */ _victory_voronoi_container__WEBPACK_IMPORTED_MODULE_0__.VictoryVoronoiContainer),
/* harmony export */   "VoronoiHelpers": () => (/* reexport safe */ _voronoi_helpers__WEBPACK_IMPORTED_MODULE_1__.VoronoiHelpers),
