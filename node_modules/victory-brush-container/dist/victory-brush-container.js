...
var Helpers = {
  ...
  getDomainBox: function (props, fullDomain, selectedDomain) {
    ...
    var fullDomainObject = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, fullDomain, props.domain);

    var selectedDomainObject = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, selectedDomain, fullDomainObject);

    var fullCoords = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDomainCoordinates(props, fullDomainObject);
    var selectedCoords = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDomainCoordinates(props, selectedDomainObject);
    return {
  ...
  getDefaultBrushArea: function (targetProps, cachedDomain, evt) {
    ...
    if (defaultBrushArea === "none") {
      ...
      var parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_5__.getParentSVG(evt);
      ...
      return victory_core__WEBPACK_IMPORTED_MODULE_5__.getBounds(_objectSpread(_objectSpread({}, constrainedBox), {}, {
        scale: scale,
  ...
  onMouseDown: function (evt, targetProps) {
    ...
    var _Selection$getSVGEven = victory_core__WEBPACK_IMPORTED_MODULE_5__.getSVGEventCoordinates(evt, parentSVG),
    ...
    var currentDomain = react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default()(brushDomain, cachedBrushDomain) ? targetProps.currentDomain || brushDomain || domain : brushDomain || domain;
    ...
    if (activeHandles) {
      ...
      x: x,
      y: y
    }, domainBox) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default()(domain, currentDomain)) {
  ...
  onGlobalMouseMove: function (evt, targetProps) {
    ...
    var _Selection$getSVGEven2 = victory_core__WEBPACK_IMPORTED_MODULE_5__.getSVGEventCoordinates(evt, parentSVG),
    ...
    if (allowDrag && isPanning) {
      ...
      var constrainedBox = this.constrainBox(pannedBox, fullDomainBox);
      var currentDomain = victory_core__WEBPACK_IMPORTED_MODULE_5__.getBounds(_objectSpread(_objectSpread({}, constrainedBox), {}, {
        scale: scale,
        horizontal: horizontal
      }));
      ...
      var _currentDomain = victory_core__WEBPACK_IMPORTED_MODULE_5__.getBounds({
        x2: x2,
        y2: y2,
        x1: targetProps.x1,
        y1: targetProps.y1,
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/rect.js");
/* harmony import */ var _brush_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./brush-helpers */ "./brush-helpers.ts");
...
var brushContainerMixin = function (base) {
  ...
  return _class = /*#__PURE__*/function (_base) {
    ...
    _createClass(VictoryBrushContainer, [{
      ...
      value: function getHandles(props, domain) {
        var handleWidth = props.handleWidth,
            ...
            name = props.name;
        var domainBox = _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.getDomainBox(props, domain);
        var x1 = domainBox.x1,
            x2 = domainBox.x2,
            y1 = domainBox.y1,
            y2 = domainBox.y2;

        var _BrushHelpers$getHand = _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.getHandles(props, domainBox),
        ...
        var handles = ["top", "bottom", "left", "right"].reduce(function (memo, curr) {
          return handleProps[curr] ? memo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(handleComponent, Object.assign({
      ...
      value: function getRect(props) {
        ...
        var domain = react_fast_compare__WEBPACK_IMPORTED_MODULE_2___default()(brushDomain, cachedBrushDomain) ? lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, currentDomain, brushDomain) : brushDomain;
        var coordinates = victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomainCoordinates(props, domain);
      ...
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_1___default().Children.toArray(props.children)), _toConsumableArray(this.getRect(props)));
      }
    }]);

    return VictoryBrushContainer;
  }(base), _class.displayName = "VictoryBrushContainer", _class.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.propTypes), {}, {
    allowDrag: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
    allowDraw: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
    allowResize: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
    brushComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
    brushDimension: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["x", "y"]),
    brushDomain: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
      x: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().array),
      y: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().array)
    }),
    brushStyle: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    defaultBrushArea: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["all", "disable", "none", "move"]),
    disable: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
    handleComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
    handleStyle: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    handleWidth: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
    onBrushCleared: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func),
    onBrushDomainChange: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func),
    onBrushDomainChangeEnd: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)
  }), _class.defaultProps = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.defaultProps), {}, {
    allowDrag: true,
    allowDraw: true,
    allowResize: true,
    brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.Rect, null),
    brushStyle: {
      stroke: "transparent",
      fill: "black",
      fillOpacity: 0.1
    },
    handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.Rect, null),
    handleStyle: {
      stroke: "transparent",
      fill: "transparent"
    },
    ...
    return [{
      ...
      eventHandlers: {
        onMouseDown: function (evt, targetProps) {
          return props.disable ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.onMouseDown(evt, targetProps);
        },
        onTouchStart: function (evt, targetProps) {
          return props.disable ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.onMouseDown(evt, targetProps);
        },
        onGlobalMouseMove: function (evt, targetProps) {
          return props.disable || !targetProps.isPanning && !targetProps.isSelecting ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.onGlobalMouseMove(evt, targetProps);
        },
        onGlobalTouchMove: function (evt, targetProps) {
          return props.disable || !targetProps.isPanning && !targetProps.isSelecting ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.onGlobalMouseMove(evt, targetProps);
        },
        onGlobalMouseUp: function (evt, targetProps) {
          return props.disable ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_3__.BrushHelpers.onGlobalMouseUp(evt, targetProps);
        },
...
var VictoryBrushContainer = brushContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer);
