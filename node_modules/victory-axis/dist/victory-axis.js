...
var getScale = function (props) {
  var axis = victory_core__WEBPACK_IMPORTED_MODULE_1__.getAxis(props);
  var currentAxis = getCurrentAxis(props, axis);
  var scale = victory_core__WEBPACK_IMPORTED_MODULE_2__.getBaseScale(props, axis);
  var propsDomain = props.domain && props.domain[axis];
  var domain = propsDomain || victory_core__WEBPACK_IMPORTED_MODULE_1__.getDomain(props) || scale.domain();
...
var getLabelPadding = function (props, style) {
  ...
  var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_1__.isVertical(props); // TODO: magic numbers
...
var getStandaloneOffset = function (props, calculatedValues) {
  ...
  var tickSizes = ticks.map(function (data, index) {
    ...
    var tickStyle = victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(style.ticks, Object.assign({}, sharedProps, {
      tick: tick,
      index: index
    }));
...
var getTransform = function (props, calculatedValues, offset) {
  var orientation = calculatedValues.orientation,
      axis = calculatedValues.axis;
  var axisValue = victory_core__WEBPACK_IMPORTED_MODULE_1__.getAxisValue(props, axis);
  return {
    top: {
      x: 0,
...
var getCalculatedValues = function (props) {
  ...
  var stringTicks = victory_core__WEBPACK_IMPORTED_MODULE_1__.stringTicks(props) ? props.tickValues : undefined;
  var axis = victory_core__WEBPACK_IMPORTED_MODULE_1__.getAxis(props);
  var axisDomain = victory_core__WEBPACK_IMPORTED_MODULE_1__.getDomain(props);
  ...
  var ticks = victory_core__WEBPACK_IMPORTED_MODULE_1__.getTicks(props, axisScale, crossAxis);
  var tickFormat = victory_core__WEBPACK_IMPORTED_MODULE_1__.getTickFormat(props, axisScale);
  var range = {
  ...
  var origin = domain.x && domain.y ? victory_core__WEBPACK_IMPORTED_MODULE_1__.getOrigin(domain) : undefined;
  ...
  var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_1__.isVertical(Object.assign({}, props, {
...
var getBaseProps = function (initialProps, fallbackProps) {
  var props = victory_core__WEBPACK_IMPORTED_MODULE_1__.modifyProps(initialProps, fallbackProps);
  ...
  var gridProps = {
    dimension: otherAxis,
    range: _defineProperty({}, otherAxis, victory_core__WEBPACK_IMPORTED_MODULE_3__.getRange(props, otherAxis)),
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/textsize.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-container/victory-container.js");
...
/* harmony import */ var _helper_methods__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./helper-methods */ "./helper-methods.tsx");
  ...
  _createClass(VictoryAxisBase, [{
    ...
    value: function renderGridAndTicks(props) {
      ...
      return this.dataKeys.map(function (key, index) {
        ...
        var BaseTickComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(tickComponent, tickProps);
        ...
        var BaseGridComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(gridComponent, gridProps);
        ...
        var TickLabel = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(tickLabelComponent, tickLabelProps);
    ...
    value: function fixLabelOverlap(gridAndTicks, props) {
      var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_2__.isVertical(props);
      ...
      var labelsSumSize = labels.reduce(function (sum, label) {
        ...
        var labelSize = victory_core__WEBPACK_IMPORTED_MODULE_3__.approximateTextSize(label.text, {
          angle: label.angle,
    ...
    value: function render() {
      ...
      var props = victory_core__WEBPACK_IMPORTED_MODULE_2__.modifyProps(this.props, fallbackProps);
      var userProps = victory_core__WEBPACK_IMPORTED_MODULE_4__.getSafeUserProps(this.props);
      ...
      var container = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(props.containerComponent, userProps);
...
VictoryAxisBase.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.CommonProps.baseProps), {}, {
  axisComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  axisLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  axisValue: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object)]),
  categories: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_6___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_6___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_6___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_6___default().string)),
    y: prop_types__WEBPACK_IMPORTED_MODULE_6___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_6___default().string))
  })]),
  crossAxis: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  dependentAxis: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  events: prop_types__WEBPACK_IMPORTED_MODULE_6___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    target: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["axis", "axisLabel", "grid", "ticks", "tickLabels"]),
    eventKey: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().array), victory_core__WEBPACK_IMPORTED_MODULE_7__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_7__.integer, victory_core__WEBPACK_IMPORTED_MODULE_7__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().string)]),
    eventHandlers: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object)
  })),
  fixLabelOverlap: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  gridComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  invertAxis: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  label: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().any),
  offsetX: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
  offsetY: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
  ...
  stringMap: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
  style: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    parent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    axis: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    axisLabel: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    grid: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    ticks: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
    tickLabels: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object)
  }),
  tickComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  tickCount: victory_core__WEBPACK_IMPORTED_MODULE_7__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_7__.integer, victory_core__WEBPACK_IMPORTED_MODULE_7__.greaterThanZero]),
  tickFormat: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().func), victory_core__WEBPACK_IMPORTED_MODULE_7__.homogeneousArray]),
  tickLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  tickValues: victory_core__WEBPACK_IMPORTED_MODULE_7__.homogeneousArray
});
VictoryAxisBase.defaultProps = {
  axisComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.LineSegment, null),
  axisLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  tickLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  tickComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.LineSegment, null),
  gridComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.LineSegment, null),
  standalone: true,
  theme: victory_core__WEBPACK_IMPORTED_MODULE_10__.VictoryTheme.grayscale,
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.VictoryContainer, null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("g", {
    role: "presentation"
  }),
  fixLabelOverlap: false
};
VictoryAxisBase.getDomain = victory_core__WEBPACK_IMPORTED_MODULE_2__.getDomain;
VictoryAxisBase.getAxis = victory_core__WEBPACK_IMPORTED_MODULE_2__.getAxis;

VictoryAxisBase.getStyles = function (props) {
  return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_12__.getStyles)(props);
};
...
var VictoryAxis = (0,victory_core__WEBPACK_IMPORTED_MODULE_13__.addEvents)(VictoryAxisBase, options);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! prop-types */ "../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js");
...
var VictoryContainer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryContainer, [{
    ...
    value: function renderContainer(props, svgProps, style) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_portal_portal_context__WEBPACK_IMPORTED_MODULE_5__.PortalContext.Provider, {
        value: {
          portalUpdate: this.portalUpdate,
          portalRegister: this.portalRegister,
          portalDeregister: this.portalDeregister
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", _extends({
        style: lodash_defaults__WEBPACK_IMPORTED_MODULE_3___default()({}, style, divStyle),
        className: className,
        ref: this.saveContainerRef
      }, this.getOUIAProps(props)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("svg", _extends({}, svgProps, {
        style: svgStyle
      }), title ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("title", {
        id: this.getIdForElement("title")
      }, title) : null, desc ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("desc", {
        id: this.getIdForElement("desc")
      }, desc) : null, children), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", {
        style: portalDivStyle
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(portalComponent, _objectSpread(_objectSpread({}, portalProps), {}, {
    ...
    value: function render() {
      ...
      var style = responsive ? this.props.style : _victory_util_helpers__WEBPACK_IMPORTED_MODULE_6__.omit(this.props.style, ["height", "width"]);
      var userProps = _victory_util_user_props__WEBPACK_IMPORTED_MODULE_7__.getSafeUserProps(this.props);
...
VictoryContainer.propTypes = {
  "aria-describedby": (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string),
  ...
  containerId: prop_types__WEBPACK_IMPORTED_MODULE_8___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_8___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string)]),
  containerRef: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().func),
  desc: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string),
  events: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().object),
  ...
  origin: prop_types__WEBPACK_IMPORTED_MODULE_8___default().shape({
  ...
  ouiaId: prop_types__WEBPACK_IMPORTED_MODULE_8___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_8___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string)]),
  ouiaSafe: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().bool),
  ouiaType: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string),
  polar: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().bool),
  portalComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  portalZIndex: _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_9__.integer,
  preserveAspectRatio: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string),
...
VictoryContainer.defaultProps = {
  ...
  portalComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_portal_portal__WEBPACK_IMPORTED_MODULE_10__.Portal, null),
  portalZIndex: 99,
  responsive: true,
  role: "img"
};
VictoryContainer.contextType = _victory_util_timer_context__WEBPACK_IMPORTED_MODULE_11__["default"];
...
/* harmony import */ var _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../victory-util/prop-types */ "../../victory-core/es/victory-util/prop-types.js");
...
var getPosition = function (props, dimension) {
  ...
  var scaledPoint = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.scalePoint(props, props.datum);
...
var getStyles = function (style, props) {
  if (props.disableInlineStyles) {
    var baseStyles = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(style, props);
    return {
  ...
  var getSingleStyle = function (s) {
    var baseStyles = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(s ? lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, s, defaultStyles) : defaultStyles, props);
...
var getBackgroundStyles = function (style, props) {
  ...
  return Array.isArray(style) && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(style) ? style.map(function (s) {
    return _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(s, props);
  }) : _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(style, props);
};
...
var getBackgroundPadding = function (props) {
  if (props.backgroundPadding && Array.isArray(props.backgroundPadding)) {
    return props.backgroundPadding.map(function (backgroundPadding) {
      var padding = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(backgroundPadding, props);
  ...
  var padding = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.backgroundPadding, props);
  return _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.getPadding({
    padding: padding
  });
};
...
var getLineHeight = function (props) {
  var lineHeight = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.lineHeight, props);
...
var getContent = function (text, props) {
  ...
  if (Array.isArray(text)) {
    return text.map(function (line) {
      return _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(line, props);
    });
  }

  var child = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(text, props);
...
var getDy = function (props, verticalAnchor, lineHeight) {
  var dy = props.dy ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.dy, props) : 0;
  var length = props.inline ? 1 : props.text.length;
  var capHeight = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.capHeight, props);
  var anchor = verticalAnchor ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(verticalAnchor, props) : "middle";
...
var getTransform = function (props, x, y) {
  ...
  var defaultAngle = polar ? _victory_util_label_helpers__WEBPACK_IMPORTED_MODULE_5__.getPolarAngle(props) : 0;
  var baseAngle = style.angle === undefined ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.angle, props) : style.angle;
  var angle = baseAngle === undefined ? defaultAngle : baseAngle;
  var transform = props.transform || style.transform;
  var transformPart = transform && _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(transform, props);
...
var getCalculatedProps = function (props) {
  ...
  var direction = props.direction ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.direction, props) : "inherit";
  var textAnchor = props.textAnchor ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.textAnchor, props) : style.textAnchor || "start";
  var verticalAnchor = props.verticalAnchor ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.verticalAnchor, props) : style.verticalAnchor || "middle";
  var dx = props.dx ? _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.dx, props) : 0;
...
var renderLabel = function (calculatedProps, tspanValues) {
  ...
  var userProps = _victory_util_user_props__WEBPACK_IMPORTED_MODULE_7__.getSafeUserProps(calculatedProps);
...
var VictoryLabel = function (initialProps) {
  ...
  var tspanValues = text.map(function (line, i) {
    ...
    var capHeightPx = _victory_util_textsize__WEBPACK_IMPORTED_MODULE_11__.convertLengthToPixels("".concat(capHeight, "em"), currentStyle.fontSize);
  ...
  if (props.backgroundStyle) {
    ...
    var backgroundWithLabel = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(props.groupComponent, {}, children);
...
VictoryLabel.propTypes = {
  ...
  angle: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  ariaLabel: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  backgroundComponent: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().element),
  backgroundPadding: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().array)]),
  backgroundStyle: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().array)]),
  capHeight: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  className: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string),
  data: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().array),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().any),
  // @ts-expect-error "Function is not assignable to string"
  desc: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  direction: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOf(["rtl", "ltr", "inherit"]),
  dx: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  dy: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  events: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().object),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().element),
  id: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  index: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string)]),
  inline: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().bool),
  labelPlacement: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOf(["parallel", "perpendicular", "vertical"]),
  lineHeight: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().array)]),
  origin: prop_types__WEBPACK_IMPORTED_MODULE_13___default().shape({
    x: _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__.nonNegative.isRequired,
    y: _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__.nonNegative.isRequired
  }),
  polar: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().bool),
  renderInPortal: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().bool),
  scale: prop_types__WEBPACK_IMPORTED_MODULE_13___default().shape({
    x: _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__.scale,
    y: _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_14__.scale
  }),
  style: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().array)]),
  tabIndex: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  text: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().array)]),
  // @ts-expect-error Function is not assignable to string"
  textAnchor: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOf(["start", "middle", "end", "inherit"]), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  textComponent: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().element),
  title: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string),
  transform: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  tspanComponent: (prop_types__WEBPACK_IMPORTED_MODULE_13___default().element),
  // @ts-expect-error Function is not assignable to string"
  verticalAnchor: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOf(["start", "middle", "end"]), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().func)]),
  // @ts-expect-error Number is not assignable to string
  x: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string)]),
  // @ts-expect-error Number is not assignable to string
  y: prop_types__WEBPACK_IMPORTED_MODULE_13___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_13___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_13___default().string)])
};
...
var evaluateProps = function (props) {
   ...
   * `tabIndex`
   */
  var ariaLabel = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.ariaLabel, props);
  var desc = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.desc, props);
  var id = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.id, props);
  var style = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateStyle(Object.assign({
    stroke: "black"
  }, props.style), props);
  var tabIndex = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.tabIndex, props);
  return Object.assign({}, props, {
    ariaLabel: ariaLabel,
    desc: desc,
    id: id,
...
var LineSegment = function (initialProps) {
  var props = evaluateProps(_objectSpread(_objectSpread({}, defaultProps), initialProps));
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(props.lineComponent, _objectSpread(_objectSpread({}, props.events), {}, {
...
var Line = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (props, ref) {
  var _evaluateProp;
  ...
  var svgProps = _objectSpread({
    ...
    id: (_evaluateProp = (0,_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp)(id, props)) === null || _evaluateProp === void 0 ? void 0 : _evaluateProp.toString(),
...
var Rect = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (props, ref) {
  var _evaluateProp;
...
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./events */ "../../victory-core/es/victory-util/events.js");
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! react-fast-compare */ "../../../node_modules/.pnpm/react-fast-compare@3.2.0/node_modules/react-fast-compare/index.js");
...
/* harmony import */ var _victory_transition_victory_transition__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../victory-transition/victory-transition */ "../../victory-core/es/victory-transition/victory-transition.js");
...
function addEvents(WrappedComponent) {
  ...
  var AddEventsMixin = /*#__PURE__*/function (_WrappedComponent) {
    ...
    function AddEventsMixin(props) {
      ...
      _this = _super.call(this, props);
      _this.state = {};
      _this.getEventState = _events__WEBPACK_IMPORTED_MODULE_10__.getEventState.bind(_assertThisInitialized(_this));
      _this.getScopedEvents = _events__WEBPACK_IMPORTED_MODULE_10__.getScopedEvents.bind(_assertThisInitialized(_this));

      _this.getEvents = function (p, target, eventKey) {
        return _events__WEBPACK_IMPORTED_MODULE_10__.getEvents.call(_assertThisInitialized(_this), p, target, eventKey, _this.getScopedEvents);
      };
    ...
    _createClass(AddEventsMixin, [{
      ...
      value: function shouldComponentUpdate(nextProps) {
        ...
        var newMutation = !react_fast_compare__WEBPACK_IMPORTED_MODULE_9___default()(externalMutations, this.externalMutations);
        ...
        if (!react_fast_compare__WEBPACK_IMPORTED_MODULE_9___default()(this.calculatedState, calculatedState)) {
          this.cacheValues(this.getCalculatedValues(nextProps));
          return true;
        }
      ...
      value: function addGlobalListener(key) {
        ...
        var boundListener = function (event) {
          ...
          return listener && listener(_events__WEBPACK_IMPORTED_MODULE_10__.emulateReactEvent(event));
        };

        this.boundGlobalEvents[key] = boundListener;
        window.addEventListener(_events__WEBPACK_IMPORTED_MODULE_10__.getGlobalEventNameFromKey(key), boundListener);
      }
    }, {
      key: "removeGlobalListener",
      value: function removeGlobalListener(key) {
        window.removeEventListener(_events__WEBPACK_IMPORTED_MODULE_10__.getGlobalEventNameFromKey(key), this.boundGlobalEvents[key]);
      ...
      value: function applyExternalMutations(props, externalMutations) {
        if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(externalMutations)) {
          var callbacks = props.externalEventMutations.reduce(function (memo, mutation) {
            return lodash_isFunction__WEBPACK_IMPORTED_MODULE_4___default()(mutation.callback) ? memo.concat(mutation.callback) : memo;
          }, []);
      ...
      value: function getCalculatedValues(props) {
        ...
        var componentEvents = _events__WEBPACK_IMPORTED_MODULE_10__.getComponentEvents(props, components);
      ...
      value: function getExternalMutations(props) {
        ...
        return lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(externalEventMutations) || sharedEvents ? undefined : _events__WEBPACK_IMPORTED_MODULE_10__.getExternalMutations(externalEventMutations, this.baseProps, this.state);
      }
    }, {
      key: "cacheValues",
      ...
      value: function getComponentProps(component, type, index) {
        ...
        if (this.hasEvents) {
          ...
          var events = lodash_defaults__WEBPACK_IMPORTED_MODULE_7___default()({}, _events__WEBPACK_IMPORTED_MODULE_10__.getPartialEvents(baseEvents, key, componentProps), componentProps.events);
      ...
      value: function renderContainer(component, children) {
        ...
        if (parentProps.events) {
          this.globalEvents = _events__WEBPACK_IMPORTED_MODULE_10__.getGlobalEvents(parentProps.events);
          parentProps.events = _events__WEBPACK_IMPORTED_MODULE_10__.omitGlobalEvents(parentProps.events);
        }

        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().cloneElement(component, parentProps, children);
      }
    }, {
      ...
      value: function animateComponent(props, defaultAnimationWhitelist) {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(_victory_transition_victory_transition__WEBPACK_IMPORTED_MODULE_11__.VictoryTransition, {
          animate: props.animate,
          animationWhitelist: animationWhitelist
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(Comp, props));
      ...
      value: function renderContinuousData(props) {
        ...
        var labelComponents = dataKeys.reduce(function (memo, key) {
          ...
          if (labelProps && labelProps.text !== undefined && labelProps.text !== null) {
            newMemo = newMemo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().cloneElement(labelComponent, labelProps));
          }

          return newMemo;
        }, []);
        var dataProps = this.getComponentProps(dataComponent, "data", "all");
        var children = [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().cloneElement(dataComponent, dataProps)].concat(_toConsumableArray(labelComponents));
      ...
      value: function renderData(props) {
        ...
        var dataComponents = this.dataKeys.reduce(function (validDataComponents, _dataKey, index) {
          ...
          if (shouldRenderDatum(dataProps.datum)) {
            validDataComponents.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().cloneElement(dataComponent, dataProps));
          }
        ...
        var labelComponents = this.dataKeys.map(function (_dataKey, index) {
          ...
          if (labelProps.text !== undefined && labelProps.text !== null) {
            return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().cloneElement(labelComponent, labelProps);
          }
...
/* harmony import */ var lodash_invert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash/invert */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/invert.js");
/* harmony import */ var lodash_invert__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_invert__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var lodash_isObject__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash/isObject */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isObject.js");
...
/* harmony import */ var lodash_isFunction__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash/isFunction */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isFunction.js");
...
/* harmony import */ var lodash_identity__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash/identity */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/identity.js");
...
/* harmony import */ var lodash_defaults__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! lodash/defaults */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/defaults.js");
/* harmony import */ var lodash_defaults__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(lodash_defaults__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _collection__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./collection */ "../../victory-core/es/victory-util/collection.js");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./helpers */ "../../victory-core/es/victory-util/helpers.js");
...
function findAxisComponents(childComponents, predicate) {
  var predicateFunction = predicate || (lodash_identity__WEBPACK_IMPORTED_MODULE_8___default());
  ...
  var findAxes = function (children) {
    return children.reduce(function (memo, child) {
      if (child.type && child.type.role === "axis" && predicateFunction(child)) {
        ...
        return memo.concat(findAxes(react__WEBPACK_IMPORTED_MODULE_10___default().Children.toArray(child.props.children)));
      }
  ...
  var findComponents = function (children) {
    return children.reduce(function (memo, child) {
      if (child.type && child.type.role === "axis" && matchesType(child)) {
        ...
        var childAxis = findComponents(react__WEBPACK_IMPORTED_MODULE_10___default().Children.toArray(child.props.children));
...
function getOrigin(domain) {
  ...
  return {
    x: _collection__WEBPACK_IMPORTED_MODULE_11__.containsDates(domain.x) ? new Date(Math.min.apply(Math, _toConsumableArray(domain.x))) : getSingleOrigin(domain.x),
    y: _collection__WEBPACK_IMPORTED_MODULE_11__.containsDates(domain.y) ? new Date(Math.min.apply(Math, _toConsumableArray(domain.y))) : getSingleOrigin(domain.y)
  };
}
function getOriginSign(origin, domain) {
  ...
  return _collection__WEBPACK_IMPORTED_MODULE_11__.containsDates(domain) ? "positive" : getSign();
}
/**
...
function stringTicks(props) {
  return props.tickValues !== undefined && _collection__WEBPACK_IMPORTED_MODULE_11__.containsStrings(props.tickValues);
}
...
function getDefaultTickFormat(props) {
  ...
  var fallbackFormat = tickValues && !_collection__WEBPACK_IMPORTED_MODULE_11__.containsDates(tickValues) ? function (x) {
    return x;
  } : undefined;
  ...
  var invertedStringMap = stringMap && lodash_invert__WEBPACK_IMPORTED_MODULE_5___default()(stringMap);
...
function getStringTicks(props) {
  ...
  var ticksFromCategories = categories && _collection__WEBPACK_IMPORTED_MODULE_11__.containsOnlyStrings(categories) ? categories.map(function (tick) {
...
function getTickArray(props) {
  ...
  var getTicksFromFormat = function () {
    ...
    return _collection__WEBPACK_IMPORTED_MODULE_11__.containsStrings(tickFormat) ? tickFormat.map(function (t, i) {
      return i;
    }) : tickFormat;
  };
  ...
  if (tickValues && _collection__WEBPACK_IMPORTED_MODULE_11__.containsStrings(tickValues)) {
    ticks = stringMap ? tickValues.map(function (tick) {
      return stringMap[tick];
    }) : _helpers__WEBPACK_IMPORTED_MODULE_12__.range(1, tickValues.length + 1);
  }

  var tickArray = ticks ? lodash_uniq__WEBPACK_IMPORTED_MODULE_4___default()(ticks) : getTicksFromFormat();
    ...
    if (arr) {
      arr.forEach(function (t, index) {
        if (Array.isArray(domain)) {
          if (t >= _collection__WEBPACK_IMPORTED_MODULE_11__.getMinValue(domain) && t <= _collection__WEBPACK_IMPORTED_MODULE_11__.getMaxValue(domain)) {
            newTickArray.push({
              value: t,
              index: index
            });
...
function getTickFormat(props, scale) {
  ...
  if (!tickFormat) {
    ...
    var scaleTickFormat = scale.tickFormat && lodash_isFunction__WEBPACK_IMPORTED_MODULE_7___default()(scale.tickFormat) ? scale.tickFormat() : function (x) {
      return x;
    };
  ...
  } else if (tickFormat && lodash_isFunction__WEBPACK_IMPORTED_MODULE_7___default()(tickFormat)) {
    var applyStringTicks = function (tick, index, ticks) {
      var invertedStringMap = lodash_invert__WEBPACK_IMPORTED_MODULE_5___default()(stringMap);
...
function getTicks(props, scale) {
  ...
  } else if (scale.ticks && lodash_isFunction__WEBPACK_IMPORTED_MODULE_7___default()(scale.ticks)) {
...
function getDomainFromData(props, axis) {
  ...
  var defaultMin = tickStrings ? 1 : _collection__WEBPACK_IMPORTED_MODULE_11__.getMinValue(ticks);
  var defaultMax = tickStrings ? tickValues.length : _collection__WEBPACK_IMPORTED_MODULE_11__.getMaxValue(ticks);
  var min = minDomain !== undefined ? minDomain : defaultMin;
  var max = maxDomain !== undefined ? maxDomain : defaultMax;
  var initialDomain = _domain__WEBPACK_IMPORTED_MODULE_13__.getDomainFromMinMax(min, max);
  var domain = polar && axis === "x" && Math.abs(startAngle - endAngle) === 360 ? _domain__WEBPACK_IMPORTED_MODULE_13__.getSymmetricDomain(initialDomain, ticks) : initialDomain;
...
function getDomain(props, axis) {
  ...
  return _domain__WEBPACK_IMPORTED_MODULE_13__.createDomainFunction(getDomainFromData)(props, inherentAxis);
}
function getAxisValue(props, axis) {
  ...
  var scale = lodash_isObject__WEBPACK_IMPORTED_MODULE_6___default()(props.scale) && lodash_isFunction__WEBPACK_IMPORTED_MODULE_7___default()(props.scale[scaleAxis]) ? props.scale[scaleAxis] : undefined;
  ...
  var stringMap = lodash_isObject__WEBPACK_IMPORTED_MODULE_6___default()(props.stringMap) && props.stringMap[stringMapAxis];
...
function modifyProps(props, fallbackProps) {
  if (!lodash_isObject__WEBPACK_IMPORTED_MODULE_6___default()(props.theme)) {
    return _helpers__WEBPACK_IMPORTED_MODULE_12__.modifyProps(props, fallbackProps, "axis");
  }
  ...
  var axisTheme = lodash_defaults__WEBPACK_IMPORTED_MODULE_9___default()({}, props.theme[role], props.theme.axis);

  var theme = Object.assign({}, props.theme, {
    axis: axisTheme
  });
  return _helpers__WEBPACK_IMPORTED_MODULE_12__.modifyProps(Object.assign({}, props, {
    theme: theme
  }), fallbackProps, "axis");
}
...
/* harmony import */ var lodash_uniq__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! lodash/uniq */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/uniq.js");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./helpers */ "../../victory-core/es/victory-util/helpers.js");
/* harmony import */ var _collection__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./collection */ "../../victory-core/es/victory-util/collection.js");
/* harmony import */ var _scale__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./scale */ "../../victory-core/es/victory-util/scale.js");
/* harmony import */ var _immutable__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./immutable */ "../../victory-core/es/victory-util/immutable.js");
...
function parseDatum(datum) {
  ...
  return _immutable__WEBPACK_IMPORTED_MODULE_12__.isImmutable(datum) ? _immutable__WEBPACK_IMPORTED_MODULE_12__.shallowToJS(datum, immutableDatumWhitelist) : datum;
}

function getLength(data) {
  return _immutable__WEBPACK_IMPORTED_MODULE_12__.isIterable(data) ? data.size : data.length;
...
function generateDataArray(props, axis) {
  ...
  var domain = propsDomain || _scale__WEBPACK_IMPORTED_MODULE_13__.getBaseScale(props, axis).domain();
  ...
  var values = _helpers__WEBPACK_IMPORTED_MODULE_14__.range(domainMin, domainMax, step);
...
function sortData(dataset, sortKey) {
  ...
  return lodash_orderBy__WEBPACK_IMPORTED_MODULE_5___default()(dataset, formattedSortKey, order);
...
function cleanData(dataset, props) {
  ...
  var scaleType = {
    x: _scale__WEBPACK_IMPORTED_MODULE_13__.getScaleType(props, "x"),
    y: _scale__WEBPACK_IMPORTED_MODULE_13__.getScaleType(props, "y")
  };
...
function formatDataFromDomain(dataset, domain, defaultBaseline) {
  ...
  var minDomainX = _collection__WEBPACK_IMPORTED_MODULE_15__.getMinValue(domain.x);
  var maxDomainX = _collection__WEBPACK_IMPORTED_MODULE_15__.getMaxValue(domain.x);
  var minDomainY = _collection__WEBPACK_IMPORTED_MODULE_15__.getMinValue(domain.y);
  var maxDomainY = _collection__WEBPACK_IMPORTED_MODULE_15__.getMaxValue(domain.y);
...
function createStringMap(props, axis) {
  ...
  var allStrings = lodash_uniq__WEBPACK_IMPORTED_MODULE_10___default()([].concat(_toConsumableArray(stringsFromAxes), _toConsumableArray(stringsFromCategories), _toConsumableArray(stringsFromData)));
...
function formatData(dataset, props, expectedKeys) {
  var isArrayOrIterable = Array.isArray(dataset) || _immutable__WEBPACK_IMPORTED_MODULE_12__.isIterable(dataset);
  ...
  var createAccessor = function (name) {
    return _helpers__WEBPACK_IMPORTED_MODULE_14__.createAccessor(props[name] !== undefined ? props[name] : name);
  };
...
function getStringsFromCategories(props, axis) {
  ...
  return categoryStrings ? _collection__WEBPACK_IMPORTED_MODULE_15__.removeUndefined(categoryStrings) : [];
}
/**
...
function getStringsFromData(props, axis) {
  var isArrayOrIterable = Array.isArray(props.data) || _immutable__WEBPACK_IMPORTED_MODULE_12__.isIterable(props.data);
  ...
  var accessor = _helpers__WEBPACK_IMPORTED_MODULE_14__.createAccessor(key); // support immutable data
...
function isDataComponent(component) {
  ...
  if (role === "portal") {
    var children = react__WEBPACK_IMPORTED_MODULE_11___default().Children.toArray(component.props.children);
...
function createDomainFunction(getDomainFromDataFunction, formatDomainFunction) {
  var getDomainFromDataFn = lodash_isFunction__WEBPACK_IMPORTED_MODULE_2___default()(getDomainFromDataFunction) ? getDomainFromDataFunction : getDomainFromData;
  var formatDomainFn = lodash_isFunction__WEBPACK_IMPORTED_MODULE_2___default()(formatDomainFunction) ? formatDomainFunction : formatDomain;
...
function getDomainFromCategories(props, axis, categories) {
  var categoriesArray = categories || _data__WEBPACK_IMPORTED_MODULE_10__.getCategories(props, axis);
  var polar = props.polar,
      _props$startAngle = props.startAngle,
      startAngle = _props$startAngle === void 0 ? 0 : _props$startAngle,
      _props$endAngle = props.endAngle,
  ...
  var minDomain = getMinFromProps(props, axis);
  var maxDomain = getMaxFromProps(props, axis);
  var stringArray = _collection__WEBPACK_IMPORTED_MODULE_8__.containsStrings(categoriesArray) ? _data__WEBPACK_IMPORTED_MODULE_10__.getStringsFromCategories(props, axis) : [];
...
function getDomainFromData(props, axis, dataset) {
  var datasetArray = dataset || _data__WEBPACK_IMPORTED_MODULE_10__.getData(props);
  var polar = props.polar,
  ...
  var parseEvent = function (eventReturn, eventKey) {
    ...
    var getKeys = function (childName) {
      ...
      if (eventReturn.eventKey === "all") {
        return newBaseProps[childName] ? lodash_without__WEBPACK_IMPORTED_MODULE_5___default()(lodash_keys__WEBPACK_IMPORTED_MODULE_0___default()(newBaseProps[childName]), "parent") : lodash_without__WEBPACK_IMPORTED_MODULE_5___default()(lodash_keys__WEBPACK_IMPORTED_MODULE_0___default()(newBaseProps), "parent");
      } else if (eventReturn.eventKey === undefined && eventKey === "parent") {
        return newBaseProps[childName] ? lodash_keys__WEBPACK_IMPORTED_MODULE_0___default()(newBaseProps[childName]) : lodash_keys__WEBPACK_IMPORTED_MODULE_0___default()(newBaseProps);
      }
    ...
    var allChildNames = childNames === "all" ? lodash_without__WEBPACK_IMPORTED_MODULE_5___default()(lodash_keys__WEBPACK_IMPORTED_MODULE_0___default()(newBaseProps), "parent") : childNames;
...
/* harmony import */ var lodash_isFunction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash/isFunction */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isFunction.js");
...
function getDefaultStyles(props, role) {
  ...
  var labelStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_4___default()({}, tooltipStyle, defaultStyles.labels);
...
function reduceChildren(children, iteratee) {
  ...
  var traverseChildren = function (childArray, names, parent) {
    return childArray.reduce(function (memo, child, index) {
      ...
      if (child.props && child.props.children) {
        var childProps = Object.assign({}, child.props, lodash_pick__WEBPACK_IMPORTED_MODULE_1___default()(parentProps, sharedProps));
        var nestedChildren = child.type && child.type.role === "stack" && lodash_isFunction__WEBPACK_IMPORTED_MODULE_3___default()(child.type.getChildren) ? child.type.getChildren(childProps) : react__WEBPACK_IMPORTED_MODULE_5___default().Children.toArray(child.props.children).map(function (c) {
          var nestedChildProps = Object.assign({}, c.props, lodash_pick__WEBPACK_IMPORTED_MODULE_1___default()(childProps, sharedProps));
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().cloneElement(c, nestedChildProps);
        });
  ...
  var validChildren = children.filter(react__WEBPACK_IMPORTED_MODULE_5__.isValidElement);
...
function isHorizontal(props) {
  ...
  var traverseChildren = function (childArray) {
    return childArray.reduce(function (memo, child) {
      ...
      return traverseChildren(react__WEBPACK_IMPORTED_MODULE_5___default().Children.toArray(childProps.children));
    }, false);
  };

  return traverseChildren(react__WEBPACK_IMPORTED_MODULE_5___default().Children.toArray(props.children));
}
...
function getInitialTransitionState(oldChildren, nextChildren) {
  ...
  var getTransitionsFromChildren = function (old, next) {
    return old.map(function (child, idx) {
      if (child && child.props && child.props.children && next[idx]) {
        return getTransitionsFromChildren(react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(old[idx].props.children), react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(next[idx].props.children));
  ...
  var childrenTransitions = getTransitionsFromChildren(react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(oldChildren), react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(nextChildren));
  return {
    nodesWillExit: nodesWillExit,
    nodesWillEnter: nodesWillEnter,
    childrenTransitions: childrenTransitions,
...
function getChildBeforeLoad(animate, child, data, cb) {
  ...
  var before = newAnimate.onLoad && newAnimate.onLoad.before ? newAnimate.onLoad.before : (lodash_identity__WEBPACK_IMPORTED_MODULE_1___default()); // If nodes need to exit, transform them with the provided onLoad.before function.
...
function getChildPropsOnEnter(animate, data, enteringNodes, cb) {
  ...
  if (enteringNodes) {
    ...
    newAnimate.onEnd = cb;
    var after = newAnimate.onEnter && newAnimate.onEnter.after ? newAnimate.onEnter.after : (lodash_identity__WEBPACK_IMPORTED_MODULE_1___default());
    newData = data.map(function (datum, idx) {
      var key = getDatumKey(datum, idx);
