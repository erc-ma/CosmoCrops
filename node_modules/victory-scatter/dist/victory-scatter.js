...
var getBubbleSize = function (datum, props) {
  ...
  var getMaxRadius = function () {
    var minPadding = Math.min.apply(Math, _toConsumableArray(lodash_values__WEBPACK_IMPORTED_MODULE_1___default()(victory_core__WEBPACK_IMPORTED_MODULE_2__.getPadding(props))));
...
var getCalculatedValues = function (props) {
  var defaultStyles = victory_core__WEBPACK_IMPORTED_MODULE_2__.getDefaultStyles(props, "scatter");
  var style = victory_core__WEBPACK_IMPORTED_MODULE_2__.getStyles(props.style, defaultStyles);
  var range = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_2__.getRange(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_2__.getRange(props, "y")
  };
  var domain = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain(props, "y")
  };
  var scale = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_4__.getBaseScale(props, "x").domain(domain.x).range(props.horizontal ? range.y : range.x),
    y: victory_core__WEBPACK_IMPORTED_MODULE_4__.getBaseScale(props, "y").domain(domain.y).range(props.horizontal ? range.x : range.y)
  };
  var origin = props.polar ? props.origin || victory_core__WEBPACK_IMPORTED_MODULE_2__.getPolarOrigin(props) : undefined;
  var z = props.bubbleProperty || "z";
  var data = victory_core__WEBPACK_IMPORTED_MODULE_5__.getData(props);
  data = victory_core__WEBPACK_IMPORTED_MODULE_5__.formatDataFromDomain(data, domain);
  return {
    domain: domain,
    data: data,
    scale: scale,
...
var getBaseProps = function (initialProps, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_2__.modifyProps(initialProps, fallbackProps, "scatter");
  ...
  return data.reduce(function (childProps, datum, index) {
    ...
    var _Helpers$scalePoint = victory_core__WEBPACK_IMPORTED_MODULE_2__.scalePoint(props, datum),
    ...
    var text = victory_core__WEBPACK_IMPORTED_MODULE_6__.getText(props, datum, index);
...
var getPath = function (props) {
  ...
  var pathFunctions = _victory_util_point_path_helpers__WEBPACK_IMPORTED_MODULE_1__;
...
var evaluateProps = function (props) {
  ...
  var size = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(props.size, props);
  var style = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_2__.evaluateStyle(props.style, props);
  var symbol = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(props.symbol, props);
...
function star(x, y, size) {
  ...
  var starCoords = _helpers__WEBPACK_IMPORTED_MODULE_0__.range(10).map(function (index) {
