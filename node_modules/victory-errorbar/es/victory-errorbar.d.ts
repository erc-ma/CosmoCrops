...
import { EventPropTypeInterface, StringOrNumberOrCallback, StringOrNumberOrList, VictoryDatableProps, VictoryCommonProps, VictoryLabelableProps, VictoryMultiLabelableProps, VictoryStyleInterface, EventsMixinClass } from "victory-core";
export declare type VictoryErrorBarTTargetType = "data" | "labels" | "parent";
export declare type ErrorType = StringOrNumberOrList | ((...args: any[]) => StringOrNumberOrList);
export interface VictoryErrorBarProps extends Omit<VictoryCommonProps, "polar">, VictoryDatableProps, VictoryLabelableProps, VictoryMultiLabelableProps {
    borderWidth?: number;
    errorX?: ErrorType;
    errorY?: ErrorType;
...
declare class VictoryErrorBarBase extends React.Component<VictoryErrorBarProps> {
...
export declare const VictoryErrorBar: {
...
} & typeof VictoryErrorBarBase;
export {};
//# sourceMappingURL=victory-errorbar.d.ts.map