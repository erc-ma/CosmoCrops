...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/line-segment.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/selection.js");
...
var getScale = function (props) {
  ...
  var fallbackScale = victory_core__WEBPACK_IMPORTED_MODULE_5__.getBaseScale(props, dimension);
  var range = victory_core__WEBPACK_IMPORTED_MODULE_6__.getRange(props, dimension);
  var domain = victory_core__WEBPACK_IMPORTED_MODULE_7__.getDomainFromProps(props, dimension) || [0, 1];
...
var withinBound = function (value, bound) {
  return value >= victory_core__WEBPACK_IMPORTED_MODULE_8__.getMinValue(bound) && value <= victory_core__WEBPACK_IMPORTED_MODULE_8__.getMaxValue(bound);
};

var getBrushDomain = function (brushDomain, fullDomain) {
  if (brushDomain) {
    var brushMin = victory_core__WEBPACK_IMPORTED_MODULE_8__.getMinValue(brushDomain);
    var brushMax = victory_core__WEBPACK_IMPORTED_MODULE_8__.getMaxValue(brushDomain);
    var domainMin = victory_core__WEBPACK_IMPORTED_MODULE_8__.getMinValue(fullDomain);
    var domainMax = victory_core__WEBPACK_IMPORTED_MODULE_8__.getMaxValue(fullDomain);
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var minDatum = Object.assign({
        handleValue: victory_core__WEBPACK_IMPORTED_MODULE_8__.getMinValue(brushDomain)
      }, datum);
      var maxDatum = Object.assign({
        handleValue: victory_core__WEBPACK_IMPORTED_MODULE_8__.getMaxValue(brushDomain)
      }, datum);
      var minHandleProps = Object.assign({
        key: "".concat(id, "-min"),
        style: victory_core__WEBPACK_IMPORTED_MODULE_6__.evaluateStyle(style, {
          datum: minDatum,
      ...
      return [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(handleComponent, minHandleProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(handleComponent, maxHandleProps)];
    }
  }, {
    key: "renderBrush",
    value: function renderBrush(props) {
      ...
      var style = victory_core__WEBPACK_IMPORTED_MODULE_6__.evaluateStyle(baseStyle, {
        datum: datum,
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(brushComponent, brushProps);
    }
  }, {
    key: "renderBrushArea",
    value: function renderBrushArea(props) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(brushAreaComponent, brushAreaProps);
    }
  }, {
    key: "renderLine",
    value: function renderLine(props) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(props.lineComponent, filteredProps);
    }
  }, {
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("g", this.props.events, this.renderLine(this.props), this.renderBrushArea(this.props), this.renderBrush(this.props), this.renderHandles(this.props));
    }
  }]);
...
VictoryBrushLine.propTypes = {
  allowDrag: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().bool),
  allowDraw: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().bool),
  allowResize: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().bool),
  brushAreaComponent: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().element),
  brushAreaStyle: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().object),
  brushAreaWidth: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number),
  brushComponent: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().element),
  brushDimension: prop_types__WEBPACK_IMPORTED_MODULE_9___default().oneOf(["x", "y"]),
  brushDomain: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().array),
  brushStyle: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().object),
  brushWidth: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number),
  className: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().string),
  dimension: prop_types__WEBPACK_IMPORTED_MODULE_9___default().oneOf(["x", "y"]),
  disable: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().bool),
  events: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().object),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().element),
  handleComponent: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().element),
  handleStyle: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().object),
  handleWidth: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number),
  ...
  lineComponent: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().element),
  name: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().string),
  onBrushDomainChange: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().func),
  scale: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().object),
  style: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().object),
  type: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().string),
  width: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number)
};
VictoryBrushLine.defaultProps = {
  allowDrag: true,
  allowDraw: true,
  allowResize: true,
  brushAreaComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.Border, null),
  brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.Border, null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("g", null),
  handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.Border, null),
  handleWidth: 10,
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.LineSegment, null),
  width: 10
};
  ...
  return props.disable ? undefined : [{
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_12__.getParentSVG(evt);
        var position = victory_core__WEBPACK_IMPORTED_MODULE_12__.getSVGEventCoordinates(evt, parentSVG)[dimension];
        ...
        var activeBrushes = {
          ...
          brush: withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default()(fullDomain, currentDomain),
      ...
      onMouseDown: function (evt, targetProps) {
        ...
        } else if (withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default()(fullDomain, currentDomain)) {
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: !targetProps.brushDomain,
          brush: withinBound(position, initialRange) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_4___default()(fullDomain, domain),
          minHandle: activeHandle === "min" || activeHandle === "both",
